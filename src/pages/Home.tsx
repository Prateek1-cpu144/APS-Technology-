        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-sm font-bold text-indigo-600 uppercase tracking-widest mb-4">Hardware Solutions</h2>
              <h3 className="text-4xl font-bold text-slate-900 mb-6">High-Performance Workstations</h3>
              <p className="text-lg text-slate-600">
                We provide specialized hardware configurations tailored to specific IT tasks, ensuring your team has the power they need to excel.
              </p>
            </div>
            <Link to="/contact" className="inline-flex items-center text-indigo-600 font-bold hover:text-indigo-700 transition-colors group">
            ...
            {[
              {
                ...
                task: "Coding & Compilation",
                specs: "32GB+ RAM, i9/Ryzen 9, Dual 4K Monitors",
                icon: "Code2",
                image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&q=80&w=800&h=500"
              },
              {
                title: "Creative & Design",
                task: "Rendering & Graphics",
                specs: "RTX 4090, Color-Accurate OLED, 64GB RAM",
                icon: "Palette",
                image: "https://images.unsplash.com/photo-1542744173-8e7e53815d1e?auto=format&fit=crop&q=80&w=800&h=500"
              },
              {
                title: "Data Science & AI",
                task: "ML Training & Big Data",
                specs: "Dual A6000 GPUs, NVMe RAID, 128GB RAM",
                icon: "BrainCircuit",
                image: "https://images.unsplash.com/photo-1551288049-bbda48658a7d?auto=format&fit=crop&q=80&w=800&h=500"
              },
              {
                title: "Enterprise Admin",
                task: "Management & Security",
                specs: "vPro Enabled, Compact Form Factor, Triple Display",
                icon: "ShieldCheck",
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="group relative bg-slate-900 rounded-3xl overflow-hidden aspect-[16/9]"
              >
                <img 
                  src={item.image} 
                  alt={item.title} 
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-end">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <span className="text-indigo-400 text-sm font-bold uppercase tracking-wider">{item.task}</span>
                  </div>
                  <h4 className="text-2xl font-bold text-white mb-2">{item.title}</h4>
                  <p className="text-slate-300 text-sm font-mono">{item.specs}</p>
                </div>
              </motion.div>
            ))}
          </div>
